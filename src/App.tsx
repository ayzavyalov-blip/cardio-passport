...
const RD = {
  ...
  lab_ref: {
    ...
    // Общий белок: норма 65–85 г/л — стандарт лабораторий РФ
    total_protein: { lo: 65, hi: 85, unit: "г/л", note: "Норма: 65–85 г/л (лаб. стандарт РФ). < 65 г/л — гипопротеинемия" },
                ...
                <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 transition-opacity ${form.labs_status==='no_labs' ? 'opacity-30 pointer-events-none' : ''}`}>
                  {[
                    ...
                    { k:'uric_acid',   l:'Мочевая кислота',
                      ...
                      unit:'мкмоль/л' },
                    { k:'total_protein', l:'Общий белок сыворотки (информационно)',
                      ref:'Норма: 65–85 г/л (лаб. стандарт РФ). Поле информационное — в расчёт баллов не включается',
                      unit:'г/л' },
